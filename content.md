...
## 2. 核心技術規格
本系統具備高採樣率與內建濾波技術，確保捕捉早期失效信號 。

| 項目 | 規格參數 | 備註 |
| :--- | :--- | :--- |
| 取樣頻寬 | 6,000 Hz | [cite_start]精準捕捉軸承早期高頻微小失效信號  |
| 導入週期 | 8 週極速導入 | [cite_start]安裝首日即啟動監控，8 週內完成診斷模型微調  |
| 硬體防護 | IP65 等級 | [cite_start]確保在切削液與高溫粉塵環境下的長期穩定性  |
